...
<html>
  ...
  <body>
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <select id="securityQuestion" name="securityQuestion" class="form-control">
          ...
          <option value="2">Favourite Teacher?</option>
          <option value="3">First Pet?</option>
          <option value="4">Favourite Sports Team?</option>
          <option value="5">Hometown?</option>
        </select>
      </div>
    </div>
    ...
    <div class="form-group">
      <label class="col-md-4 control-label" for="securityAnswer">Answer:</label>
      <div class="col-md-4">
